...
mkdir -p slides
# テンプレートをコピー
cp .claude/skills/marp-slide-writer/templates/basic-template.md slides/slides.md
```
...
```bash
python .claude/skills/marp-slide-writer/scripts/validate_slides.py slides/slides.md
```
...
npx @marp-team/marp-cli slides/slides.md --html --preview --watch
```
